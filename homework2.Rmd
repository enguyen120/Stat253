...
life_rec<- recipe(`Life expectancy at birth, total (years)` ~ ., data = lifeExpectancy) %>% #start with formula; y ~ . means include all predictors in the data set
